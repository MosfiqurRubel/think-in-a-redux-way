          ...
          <div className="cartCard">
            ...
            <div className="flex items-center justify-center col-span-4 mt-4 space-x-8 md:mt-0">
              ...
              <div className="flex items-center space-x-4">
                <button className="lws-incrementQuantity cursor-pointer">
                  <Plus className="hover:stroke-primary" />
                </button>
                <span className="lws-cartQuantity">2</span>
                <button className="lws-decrementQuantity cursor-pointer">
                  <Minus className="hover:stroke-primary" />
                </button>
              </div>
              {/* price */}
