...
const Error = ({ children, className }) => {
  // Use standard Tailwind classes for alignment and colors
  const baseStyles =
    "w-full flex items-center justify-center h-10 max-w-7xl mx-auto p-2 text-danger-700 bg-danger-100 col-span-12";
